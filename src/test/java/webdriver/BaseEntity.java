...
public abstract class BaseEntity {
    ...
    /**
     * Process {@link webdriver.annotations.Bug} annotation if test marked by it.
     ...
     * Otherwise text from {@link webdriver.annotations.Bug#title()} will be printed to report.
